...
If you find a security vulnerability in pyutils, please report it through [GitHub's private vulnerability reporting](https://github.com/baskettaz/pyutils/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact vcvetanov@yahoo.com for details.
